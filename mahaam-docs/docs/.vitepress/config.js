  ...
  themeConfig: {
    ...
    sidebar: {
      "/": [
        ...
        {
          text: "Microservices Module",
          items: [
            { text: "Intro", link: "/module/intro" },
            { text: "Repo Layer", link: "/module/repos" },
            { text: "Service Layer", link: "/module/services" },
            { text: "Controller Layer", link: "/module/controllers" },
            { text: "Models", link: "/module/models" },
            { text: "Transactions", link: "/module/transactions" },
          ],
        },
        {
          text: "Microservices Infra",
          items: [
